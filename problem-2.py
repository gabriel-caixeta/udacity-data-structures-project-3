...
test_function(3, [[6, 7, 8, 1, 2, 3, 4], 10], "non-existent item")
test_function(4, [[1, 2, 3, 4, 5, 6, 7], 3], "non-rotated array")
test_function(5, [[6, 7, 8, 9, 10, 1, 2, 3, 4], 6], "front of rotation")
test_function(6, [[6, 7, 8, 9, 10, 1, 2, 3, 4], 3], "back of rotation")
test_function(7, [[6, 7, 8, 1, 2, 3, 4], 8], "highest item in array")
test_function(8, [[6, 7, 8, 1, 2, 3, 4], 1], "lowest item in array")